package com.cosmetics.admin.paging;
...
public class PagingAndSortingHelper {
    ...
    public Pageable createPageableForVariant(int pageSize, int pageNum) {

        String resolved = sortField; // sortField lấy từ request

        switch (sortField) {
            case "brand":
                resolved = "product.brand.name";
                break;

            case "category":
                resolved = "product.category.name";
                break;

package com.cosmetics.admin.user.controller;
...
import com.cosmetics.admin.user.UserNotFoundException;
import com.cosmetics.admin.user.UserService;
import com.cosmetics.admin.user.export.UserCsvExporter;
import com.cosmetics.admin.user.export.UserExcelExporter;
import com.cosmetics.admin.user.export.UserPdfExporter;
import com.cosmetics.common.entity.Role;
...
//                             Model model, @AuthenticationPrincipal CosmeticsUserDetails loggedUser,
//                             RedirectAttributes redirectAttributes) {
//        try {
...
//    }
    ...
    public String updateUserEnabledStatus(@PathVariable("id") Integer id, @AuthenticationPrincipal CosmeticsUserDetails loggedUser,

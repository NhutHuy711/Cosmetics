package com.cosmetics.admin.shippingrate;
...
public class ShippingRateService {
    ...
    public float calculateShippingCost(Integer productVariantId, Integer countryId, String state)
        ...
        return productVariant.getWeight() * shippingRate.getRate();
    }
}

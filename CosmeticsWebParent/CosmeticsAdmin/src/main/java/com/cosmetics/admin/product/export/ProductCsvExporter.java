package com.cosmetics.admin.product.export;

import com.cosmetics.admin.AbstractExporter;
...
public class ProductCsvExporter extends AbstractExporter {
    ...
    public void export(List<Product> listProducts, HttpServletResponse response) throws IOException {
        ...
        String[] csvHeader = {"Product ID", "Product Name", "Created Time", "Enabled"};
        String[] fieldMapping = {"id", "name", "createdAt", "enabled"};

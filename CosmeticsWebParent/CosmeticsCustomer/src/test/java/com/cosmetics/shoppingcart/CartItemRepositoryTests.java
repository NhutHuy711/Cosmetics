...
//
//        Customer customer = entityManager.find(Customer.class, customerId);
//        ProductVariant product = entityManager.find(Product.class, productId);
//
//        CartItem item1 = new CartItem();
//        item1.setCustomer(customer);
//        item1.setVariant(product);
//        item1.setQuantity(2);
//
...
//        Integer productId = 1;
//
//        CartItem item = repo.findByCustomerAndProductVariant(new Customer(customerId), new ProductVariant(productId));
//
...
//
//        CartItem item = repo.findByCustomerAndProduct(new Customer(customerId), new ProductVariant(productId));
//

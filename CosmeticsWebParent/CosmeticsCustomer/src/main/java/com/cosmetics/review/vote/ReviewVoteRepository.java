package com.cosmetics.review.vote;
...
import com.cosmetics.common.entity.ReviewVote;
...
public interface ReviewVoteRepository extends JpaRepository<ReviewVote, Integer> {
    ...
    @Query("SELECT v FROM ReviewVote v WHERE v.review.productVariant.product.id = ?1 AND v.customer.id = ?2")
